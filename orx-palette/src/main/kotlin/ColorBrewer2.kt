...
class ColorBrewer2Palette(val palette: List<ColorRGBa>, val type: ColorBrewer2Type) {
...
fun colorBrewer2Palettes(
    ...
    numberOfColors == -1 && paletteType == ColorBrewer2Type.Any -> colorBrewer2
    paletteType == ColorBrewer2Type.Any -> colorBrewer2.filter { it.len == numberOfColors }
    else -> colorBrewer2.filter { it.type == paletteType }
}

fun main() {
    // Usages
    val palette1 = colorBrewer2Palettes(numberOfColors = 5).random().palette
    val palette2 = colorBrewer2Palettes().last().palette
    val palette3 = colorBrewer2Palettes(paletteType = ColorBrewer2Type.Sequential)[4].palette
    val palette4 = colorBrewer2[66].palette

    // Number of palettes
    println("ColorBrewer2 provides ${colorBrewer2.size} palettes")
    println("The last one in the collection has ${palette2.size} colors which are:")
    palette2.forEach { println(it) }
}
