...
fun main() = application {
    program {
        val suzanne = loadOBJasVertexBuffer("demo-data/obj-models/suzanne/Suzanne.obj")
        println(suzanne.vertexCount)
        extend {
            ...
            drawer.vertexBuffer(suzanne, DrawPrimitive.TRIANGLES)
        }
    }
}